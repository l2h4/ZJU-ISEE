...
/* INSERT YOUR CODE FROM HERE */
    ...
    /// Encode "Selfopt rd, rs1, rs2" into this object.
    bool encodeSelfopt(unsigned rd, unsigned rs1, unsigned rs2);

    /// Encode "Addlli rd, rs1, rs2" into this object.
    bool encodeAddlli(unsigned rd, unsigned rs1, unsigned rs2);
