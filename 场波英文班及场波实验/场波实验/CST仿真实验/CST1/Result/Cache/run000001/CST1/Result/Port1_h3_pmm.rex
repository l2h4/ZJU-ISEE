...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <SimulationProperties dB_Amplitude="20" encoded_unit="&amp;U:A^1.:m^-1" fieldname="&lt;name missing&gt;" fieldtype="H-Field" frequency="0" label="Port1 h3"/>
  <MetaGeometryFile filename="" lod="1"/>
  <ResultGroups num_steps="1">
    <Frame index="0" characteristic="10.299999999999998934" tfo="Port1_h3_pmm_10.3.tfo">
      <FieldResultFile filename="Port1_h3[10.3].prt" meshname="Port1_h3_pmm.slim" type="prt"/>
    </Frame>
  </ResultGroups>
