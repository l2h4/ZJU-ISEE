...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <ResultGroups num_steps="1">
    <Frame index="0" characteristic="10.299999999999998934" tfo="Port1_h1_pmm_10.3.tfo">
      <FieldResultFile filename="Port1_h1[10.3].prt" meshname="Port1_h1_pmm.slim" type="prt"/>
    </Frame>
  </ResultGroups>
